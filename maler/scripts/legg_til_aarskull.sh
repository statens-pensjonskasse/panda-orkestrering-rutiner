...
# Beskrivelse:
#===========================================================
# Kopierer flettede kontofoeringsfiler for 2022.09.01 fra
...
# 2022.09.01/grunnlagsdata_2022-08-31_00-00-00-00
#===========================================================
...
GRUNNLAGSDATAMAPPE="grunnlagsdata_2022-09-02_04-25-05-35"
...
echo "`date` - Starter kopiering av flettede kontofoeringer for 2022.09.01"
...
if [ -d ${GRUNNLAGSDATAMAPPE_I_ARKIV} ]
    then
        ...
        echo "Finner ikke filene for flettede kontoføringer 2022.09.01 i arkivet"
fi

echo "`date` - Kopiering av flettede kontofoeringer er ferdig"